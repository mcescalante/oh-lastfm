...
class DataSourceMember(models.Model):
    ...
    lastfm_id = models.CharField(max_length=255, unique=True, null=True)
    access_token = models.CharField(max_length=512, null=True)
    session_key = models.CharField(max_length=512, null=True)
    api_signature = models.CharField(max_length=512, null=True)
